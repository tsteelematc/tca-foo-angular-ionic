...
/* harmony import */ var _index_4a9ebc6d_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./index-4a9ebc6d.js */ 591);
...
let App = class {
  ...
  componentDidLoad() {
    ...
    {
      rIC( /*#__PURE__*/(0,C_Users_t_ste_Documents_GitHub_2022_spring_adv_fe_tsteelematc_tca_foo_angular_ionic_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
        ...
        if (!_ionic_global_a049bcbf_js__WEBPACK_IMPORTED_MODULE_2__.c.getBoolean('_testing')) {
          __webpack_require__.e(/*! import() */ "node_modules_ionic_core_dist_esm_tap-click-a895802b_js").then(__webpack_require__.bind(__webpack_require__, /*! ./tap-click-a895802b.js */ 8286)).then(module => module.startTapClick(_ionic_global_a049bcbf_js__WEBPACK_IMPORTED_MODULE_2__.c));
        }

        if (_ionic_global_a049bcbf_js__WEBPACK_IMPORTED_MODULE_2__.c.getBoolean('statusTap', isHybrid)) {
          __webpack_require__.e(/*! import() */ "node_modules_ionic_core_dist_esm_status-tap-c10ad309_js").then(__webpack_require__.bind(__webpack_require__, /*! ./status-tap-c10ad309.js */ 2579)).then(module => module.startStatusTap());
        }

        if (_ionic_global_a049bcbf_js__WEBPACK_IMPORTED_MODULE_2__.c.getBoolean('inputShims', needInputShims())) {
          __webpack_require__.e(/*! import() */ "node_modules_ionic_core_dist_esm_input-shims-61232da0_js").then(__webpack_require__.bind(__webpack_require__, /*! ./input-shims-61232da0.js */ 3294)).then(module => module.startInputShims(_ionic_global_a049bcbf_js__WEBPACK_IMPORTED_MODULE_2__.c));
        }
  ...
  setFocus(elements) {
    ...
    return (0,C_Users_t_ste_Documents_GitHub_2022_spring_adv_fe_tsteelematc_tca_foo_angular_ionic_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
...
let Footer = class {
  constructor(hostRef) {
    ...
    this.setupFadeFooter = /*#__PURE__*/function () {
      var _ref2 = (0,C_Users_t_ste_Documents_GitHub_2022_spring_adv_fe_tsteelematc_tca_foo_angular_ionic_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (contentEl) {
        if (!contentEl) {
...
let Header = class {
  constructor(hostRef) {
    ...
    this.setupFadeHeader = /*#__PURE__*/function () {
      var _ref3 = (0,C_Users_t_ste_Documents_GitHub_2022_spring_adv_fe_tsteelematc_tca_foo_angular_ionic_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (contentEl, condenseHeader) {
        if (!contentEl) {
